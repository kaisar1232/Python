...
def data_file_to_csv():
    # Headers
    headers = ["CodeNumber", "ClumpThickness", "UniformityCellSize", "UniformityCellShape", "MarginalAdhesion", "BareNuclei", "BlandChromatin", "NormalNucleoli", "Mitoses", "SingleEpithelialCellSize", "CancerType"]
...
def main():
    ...
    train_x, test_x, train_y, test_y = split_dataset(dataset, 0.7, HEADERS[1:10], HEADERS[10])
