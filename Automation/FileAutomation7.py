    ...
    if (exist == True):
        for foldername, subfoldername, filename in os.walk(DirName):
            for fname in filename:
                if(fname==name):
                    print("File Is Present With Directory With Name:",fname)
...
def main():
    ...
    if(argv[1] == "-h" or argv[1] == "-H"):    # Flag for displaying help
        ...
        print("Usage : Name_Of_Script First_Argument,Seconf Argument")
...
# python FileAutomation.py Directory_Name File_Namw